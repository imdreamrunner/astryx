import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./jsx-runtime-DqZldVDK.js";import{i as n,t as r}from"./Avatar-BET4RBn-.js";import{D as i,E as a,_i as o,bi as s,vi as c}from"./iframe-DqVthoaH.js";var l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w;e((()=>{o(),r(),a(),l=t(),u=[{name:`Alice Johnson`,src:`https://i.pravatar.cc/150?img=1`,key:`alice`},{name:`Bob Smith`,src:`https://i.pravatar.cc/150?img=2`,key:`bob`},{name:`Charlie Davis`,src:`https://i.pravatar.cc/150?img=3`,key:`charlie`},{name:`Diana Lee`,src:`https://i.pravatar.cc/150?img=4`,key:`diana`},{name:`Eve Park`,src:`https://i.pravatar.cc/150?img=5`,key:`eve`}],d={title:`Core/AvatarGroup`,component:s,tags:[`autodocs`],argTypes:{size:{control:`select`,options:[`tiny`,`xsmall`,`small`,`medium`,`large`],description:`Size applied to all child avatars`}}},f={render:()=>(0,l.jsx)(s,{size:`medium`,children:u.slice(0,3).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key))})},p={render:()=>(0,l.jsxs)(s,{size:`medium`,children:[u.slice(0,3).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(c,{count:u.length-3})]})},m={render:()=>(0,l.jsxs)(s,{size:`medium`,children:[u.slice(0,3).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(c,{count:u.length-3,onClick:()=>alert(`Show all participants`)})]})},h={render:()=>(0,l.jsxs)(s,{size:`medium`,children:[u.slice(0,3).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(c,{count:44})]})},g={render:()=>(0,l.jsxs)(s,{size:`medium`,children:[(0,l.jsx)(n,{src:`https://i.pravatar.cc/150?img=1`,name:`Alice`,status:(0,l.jsx)(i,{variant:`success`,label:`Online`})}),(0,l.jsx)(n,{src:`https://i.pravatar.cc/150?img=2`,name:`Bob`,status:(0,l.jsx)(i,{variant:`warning`,label:`Away`})}),(0,l.jsx)(n,{src:`https://i.pravatar.cc/150?img=3`,name:`Charlie`,status:(0,l.jsx)(i,{variant:`error`,label:`Offline`})})]})},_={render:()=>(0,l.jsx)(`div`,{className:`x78zum5 xdt5ytf x1qh66ti`,children:[`tiny`,`xsmall`,`small`,`medium`,`large`].map(e=>(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`h4`,{className:`xrcdmg7 x9ynric`,children:e}),(0,l.jsxs)(s,{size:e,children:[u.slice(0,3).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(c,{count:u.length-3})]})]},e))})},v={render:()=>(0,l.jsxs)(s,{size:`medium`,children:[u.slice(0,4).map(e=>(0,l.jsx)(n,{name:e.name},e.key)),(0,l.jsx)(c,{count:1})]})},y={render:()=>(0,l.jsx)(s,{size:`medium`,children:(0,l.jsx)(n,{src:`https://i.pravatar.cc/150?img=1`,name:`Alice Johnson`})})},b={render:()=>(0,l.jsxs)(s,{size:`medium`,children:[u.slice(0,3).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(c,{count:999})]})},x={render:()=>(0,l.jsxs)(s,{size:`medium`,children:[u.slice(0,3).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(c,{count:0})]})},S={render:()=>(0,l.jsx)(`div`,{style:{width:120,border:`1px dashed grey`,padding:8},children:(0,l.jsxs)(s,{size:`medium`,children:[u.slice(0,5).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(c,{count:10})]})})},C={render:()=>(0,l.jsxs)(s,{size:`small`,children:[Array.from({length:10},(e,t)=>({key:`user-${t}`,name:`User ${t+1}`,src:`https://i.pravatar.cc/150?img=${t%70+1}`})).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(c,{count:37})]})},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
