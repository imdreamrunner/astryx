...
│ (shared observer)   │
└─────────────────────┘`,language:`text`})]})}])},[]),S=(0,b.useCallback)(()=>{clearInterval(o.current),r(!1),c.current=0,t([{id:1,role:`user`,text:`Can you analyze the auto-scroll system and fix the issue with tool calls?`},{id:2,role:`assistant`,text:"Sure, I'll look into the auto-scroll behavior. Let me start by reading the relevant files.\n\nThe scroll system uses `useChatStreamScroll` for spring-based scroll tracking and `useChatNewMessages` for content observation."},{id:3,role:`user`,text:`Great, show me what you find.`}])},[]);return(0,x.jsxs)(`div`,{className:`x1dr59a3 x78zum5 xdt5ytf`,children:[(0,x.jsxs)(`div`,{className:`x78zum5 x167g77z xc7ga6q x4befzd x1a02dak x6s0dn4`,children:[(0,x.jsx)(a,{label:`Stream Text (works ✓)`,variant:`primary`,size:`sm`,onClick:u,isDisabled:n}),(0,x.jsx)(a,{label:`Add Tool Call (may fail ✗)`,variant:`secondary`,size:`sm`,onClick:d}),(0,x.jsx)(a,{label:`Batch Tool Calls (likely fails ✗)`,variant:`secondary`,size:`sm`,onClick:p}),(0,x.jsx)(a,{label:`Add Custom Element (may fail ✗)`,variant:`secondary`,size:`sm`,onClick:_}),(0,x.jsx)(a,{label:`Reset`,variant:`ghost`,size:`sm`,onClick:S}),(0,x.jsx)(`div`,{className:`xvc5jky x78zum5 x6s0dn4 x17d4w8g`,children:(0,x.jsx)(s,{variant:n?`green`:`neutral`,label:n?`Streaming`:`Idle`})})]}),(0,x.jsx)(y,{composer:(0,x.jsx)(f,{onSubmit:()=>{},placeholder:`Observe auto-scroll behavior above...`,isStopShown:n}),children:(0,x.jsx)(h,{children:e.map(e=>(0,x.jsxs)(g,{sender:e.role,children:[e.text&&(0,x.jsx)(m,{density:`compact`,children:e.text}),e.toolCalls&&e.toolCalls.length>0&&(0,x.jsx)(v,{calls:e.toolCalls}),e.customElement]},e.id))})})]})}},E={name:`Rapid Tool Calls`,render:()=>{let[e,t]=(0,b.useState)([{id:1,role:`user`,text:`Run the full test suite across all packages.`}]),[n,r]=(0,b.useState)(!1),i=(0,b.useRef)(void 0),o=(0,b.useRef)(0),c=(0,b.useCallback)(()=>{r(!0),o.current=0,i.current=setInterval(()=>{if(o.current++,o.current>10){clearInterval(i.current),r(!1);return}let e=Date.now()+o.current,n=[`read`,`bash`,`edit`,`ipython`,`show`],a=[`Button.test.tsx`,`yarn test --filter=Button`,`Button.tsx +8 -2`,`analyze_coverage()`,`coverage-report.html`],s=(o.current-1)%n.length;t(t=>[...t,{id:e,role:`assistant`,text:``,toolCalls:[{key:String(e),name:n[s]??`read`,target:a[s],status:`running`,node:`astryx`}]}]),setTimeout(()=>{t(t=>t.map(t=>t.id===e?{...t,toolCalls:[{key:String(e),name:n[s]??`read`,target:a[s],status:`complete`,duration:`${(Math.random()*3+.1).toFixed(1)}s`,node:`astryx`}]}:t))},300)},500)},[]),l=(0,b.useCallback)(()=>{clearInterval(i.current),r(!1)},[]),u=(0,b.useCallback)(()=>{clearInterval(i.current),r(!1),o.current=0,t([{id:1,role:`user`,text:`Run the full test suite across all packages.`}])},[]);return(0,x.jsxs)(`div`,{className:`x1dr59a3 x78zum5 xdt5ytf`,children:[(0,x.jsxs)(`div`,{className:`x78zum5 x167g77z xc7ga6q x4befzd x1a02dak x6s0dn4`,children:[(0,x.jsx)(a,{label:n?`Running...`:`Start Rapid Tool Calls`,variant:`primary`,size:`sm`,onClick:c,isDisabled:n}),(0,x.jsx)(a,{label:`Stop`,variant:`destructive`,size:`sm`,onClick:l,isDisabled:!n}),(0,x.jsx)(a,{label:`Reset`,variant:`ghost`,size:`sm`,onClick:u}),(0,x.jsx)(`div`,{className:`xvc5jky x78zum5 x6s0dn4 x17d4w8g`,children:(0,x.jsx)(s,{variant:n?`yellow`:`neutral`,label:n?`Tool call ${o.current}/10`:`${e.length-1} messages`})})]}),(0,x.jsx)(y,{composer:(0,x.jsx)(f,{onSubmit:()=>{},placeholder:`Watch scroll behavior...`}),children:(0,x.jsx)(h,{children:e.map(e=>(0,x.jsxs)(g,{sender:e.role,children:[e.text&&(0,x.jsx)(m,{density:`compact`,children:e.text}),e.toolCalls&&e.toolCalls.length>0&&(0,x.jsx)(v,{calls:e.toolCalls})]},e.id))})})]})}},D={name:`Mixed Stream + Tools`,render:()=>{let[e,t]=(0,b.useState)([{id:1,role:`user`,text:`Fix the focus ring and run the tests.`}]),[n,r]=(0,b.useState)(`idle`),i=(0,b.useRef)(void 0),o=(0,b.useCallback)(()=>{r(`streaming`);let e=Date.now(),n=`Let me look at the Button component's focus styles and fix the ring.
