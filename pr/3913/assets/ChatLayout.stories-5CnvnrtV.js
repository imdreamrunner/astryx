...
Cards now adapt across themes. All tests pass.`,[{key:`r1`,name:`read`,target:`Card.tsx`,status:`complete`,duration:`35ms`,node:`astryx`},{key:`e1`,name:`edit`,target:`Card.tsx`,status:`complete`,duration:`90ms`,node:`astryx`,additions:1,deletions:1},{key:`t1`,name:`bash`,target:`yarn test --filter Card`,status:`complete`,duration:`3.2s`,node:`astryx`}])},2e3)},[n,h]),onStop:(0,R.useCallback)(()=>{clearInterval(c.current),s(!1),t(e=>e.map(e=>e.role===`assistant`&&e.isStreaming?{...e,isStreaming:!1}:e))},[]),isStopShown:o,drawer:n.length>0?(0,z.jsx)(y,{children:n.map(e=>(0,z.jsx)(f,{label:e,onRemove:()=>r(t=>t.filter(t=>t!==e))},e))}):void 0,headerActions:(0,z.jsxs)(z.Fragment,{children:[(0,z.jsx)(a,{label:`Mention`,variant:`ghost`,size:`sm`,icon:H,isIconOnly:!0,onClick:()=>{l.current?.focus(),l.current?.insertText(`@`)}}),(0,z.jsx)(a,{label:`Attach`,variant:`ghost`,size:`sm`,icon:V,isIconOnly:!0,onClick:()=>r(e=>[...e,`file-${e.length+1}.tsx`])})]}),headerContext:(0,z.jsxs)(z.Fragment,{children:[(0,z.jsx)(C,{ref:u.ref,"aria-describedby":u.describedBy,label:`Context`,value:12,variant:`neutral`,isLabelHidden:!0,style:{marginInlineEnd:8}}),u.renderTooltip(`3k / 100k tokens used`)]}),input:(0,z.jsx)(T,{handleRef:l,triggers:p,placeholder:`Ask about the codebase...`}),footerActions:(0,z.jsx)(a,{label:`Claude Opus`,variant:`ghost`,size:`md`}),sendActions:(0,z.jsx)(a,{label:`Microphone`,variant:`ghost`,size:`md`,icon:U,isIconOnly:!0})}),children:(0,z.jsx)(O,{children:e.map(e=>{if(e.role===`system`)return(0,z.jsx)(_,{variant:`divider`,children:e.text},e.id);if(e.role===`user`)return(0,z.jsxs)(k,{sender:`user`,children:[e.files&&(0,z.jsx)(y,{children:e.files.map(e=>(0,z.jsx)(f,{label:e},e))}),(0,z.jsx)(v,{metadata:(0,z.jsx)(w,{timestamp:(0,z.jsx)(j,{value:e.sentAt?.toISOString()??new Date(e.id).toISOString(),format:`time`}),status:e.isSending?`sending`:void 0}),children:(0,z.jsx)(S,{tokens:d,children:e.text})})]},e.id);let t=e.introText?.length??0,n=e.toolCalls&&e.toolCalls.length>0,r=t>0?e.text.slice(0,t):null,i=t>0&&e.text.length>t?e.text.slice(t).replace(/^\n+/,``):t?null:e.text;return(0,z.jsxs)(k,{sender:`assistant`,children:[r&&(0,z.jsx)(D,{density:`compact`,children:r}),n&&(0,z.jsx)(M,{calls:e.toolCalls??[]}),i&&(0,z.jsx)(D,{density:`compact`,children:i}),!e.isStreaming&&e.text&&(0,z.jsx)(w,{timestamp:(0,z.jsx)(j,{value:new Date(e.id).toISOString(),format:`time`}),footer:(0,z.jsxs)(z.Fragment,{children:[(0,z.jsx)(`span`,{children:`Claude Opus 4.6`}),(0,z.jsx)(`span`,{children:`·`}),(0,z.jsx)(a,{label:`Thumbs up`,icon:(0,z.jsx)(F,{style:{width:14,height:14}}),variant:`ghost`,size:`sm`,isIconOnly:!0}),(0,z.jsx)(a,{label:`Thumbs down`,icon:(0,z.jsx)(L,{style:{width:14,height:14}}),variant:`ghost`,size:`sm`,isIconOnly:!0}),(0,z.jsx)(a,{label:`Copy`,icon:(0,z.jsx)(P,{style:{width:14,height:14}}),variant:`ghost`,size:`sm`,isIconOnly:!0})]})})]},e.id)})})})})}},J={name:`Panel View`,render:()=>{let[e,t]=(0,R.useState)(K),[n,r]=(0,R.useState)([]),[i,o]=(0,R.useState)(!1),s=(0,R.useRef)(void 0),c=(0,R.useRef)(null),l=W.map(e=>({value:`@${e.id}`,label:`@${e.label}`,variant:`blue`})),u=[{character:`@`,searchSource:m(W),onSelect:e=>({value:`@${e.id}`,label:`@${e.label}`,variant:`blue`})},{character:`/`,searchSource:m(G),onSelect:e=>`/${e.label} `}],d=(0,R.useCallback)((e,n)=>{let r=Date.now();o(!0),t(e=>[...e,{id:r,role:`assistant`,text:``,isStreaming:!0}]);let i=0,a=e+`

`+n;s.current=setInterval(()=>{if(i+=3+Math.floor(Math.random()*5),i>=a.length){clearInterval(s.current),t(e=>e.map(e=>e.id===r?{...e,text:a,isStreaming:!1}:e)),o(!1);return}t(e=>e.map(e=>e.id===r?{...e,text:a.slice(0,i)}:e))},30)},[]);return(0,z.jsx)(`div`,{style:{width:400,height:600,border:`1px solid #ccc`,borderRadius:8,overflow:`hidden`},children:(0,z.jsx)(N,{composer:(0,z.jsx)(b,{onSubmit:(0,R.useCallback)(e=>{t(t=>[...t,{id:Date.now(),role:`user`,text:e,files:n.length?[...n]:void 0}]),r([]),setTimeout(()=>{d(`Checking the component now.`,`Found the issue — the border radius was hardcoded. Replaced with the theme token.`)},800)},[n,d]),onStop:(0,R.useCallback)(()=>{clearInterval(s.current),o(!1),t(e=>e.map(e=>e.role===`assistant`&&e.isStreaming?{...e,isStreaming:!1}:e))},[]),isStopShown:i,drawer:n.length>0?(0,z.jsx)(y,{children:n.map(e=>(0,z.jsx)(f,{label:e,onRemove:()=>r(t=>t.filter(t=>t!==e))},e))}):void 0,headerActions:(0,z.jsxs)(z.Fragment,{children:[(0,z.jsx)(a,{label:`Mention`,variant:`ghost`,size:`sm`,icon:H,isIconOnly:!0,onClick:()=>{c.current?.focus(),c.current?.insertText(`@`)}}),(0,z.jsx)(a,{label:`Attach`,variant:`ghost`,size:`sm`,icon:V,isIconOnly:!0,onClick:()=>r(e=>[...e,`file-${e.length+1}.tsx`])})]}),input:(0,z.jsx)(T,{handleRef:c,triggers:u,placeholder:`Ask something...`})}),children:(0,z.jsx)(O,{children:e.map(e=>e.role===`system`?(0,z.jsx)(_,{variant:`divider`,children:e.text},e.id):e.role===`user`?(0,z.jsxs)(k,{sender:`user`,children:[e.files&&(0,z.jsx)(y,{children:e.files.map(e=>(0,z.jsx)(f,{label:e},e))}),(0,z.jsx)(v,{children:(0,z.jsx)(S,{tokens:l,children:e.text})})]},e.id):(0,z.jsxs)(k,{sender:`assistant`,children:[e.text&&(0,z.jsx)(D,{density:`compact`,children:e.text}),e.toolCalls&&e.toolCalls.length>0&&(0,z.jsx)(M,{calls:e.toolCalls??[]})]},e.id))})})})}},Y={name:`Empty State`,render:()=>(0,z.jsx)(`div`,{style:{height:`100vh`,display:`flex`,flexDirection:`column`},children:(0,z.jsx)(N,{composer:(0,z.jsx)(b,{onSubmit:()=>{},placeholder:`Start a conversation…`}),emptyState:(0,z.jsx)(u,{title:`No messages yet`,description:`Start a conversation by typing below.`}),children:[]})})},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
  name: 'Full AI Chat',
  render: () => {
